...
HF_REPO_ID = 'rahilsid/brain_tumor_detection'
HF_MODEL_FILENAME = 'hybrid_full.pth'
    ...
    if not weights_path or not os.path.exists(weights_path):
        ...
        if not weights_path or not os.path.exists(weights_path):
            raise FileNotFoundError(
                'Hybrid weights not found. Put hybrid_full.pth in the repo root or models/, or let the app download it from Hugging Face.'
            )
    try:
